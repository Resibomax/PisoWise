      ...
      <div className="flex bg-[#1B1212]/45 backdrop-blur-md shadow-lg w-full min-h-[52px] px-4">
        <div className="flex items-center justify-between py-2 lg:px-[2rem] mx-auto w-full">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent
              className="border-none shadow-lg bg-opacity-90 backdrop-blur-md"
              align="end"
            >
              <DropdownMenuItem
                className="cursor-pointer text-white flex justify-center py-2 px-4 rounded-md transition-all duration-500 hover:brightness-110"
                style={{
                  background:
