    ...
    <div className="w-full max-w-7xl mx-auto mt-4 p-4 md:px-8 lg:px-16">
      <div className="flex flex-row items-center justify-between md:justify-start gap-6 w-full mb-6">
        ...
        <Button
          ...
          className="bg-[#1B1212] hover:bg-[#FBF5F3] hover:text-black text-white font-[Ember] rounded-[12px] text-[16px]"
        >
      ...
      <CreateProjectModal isOpen={isCreateModalOpen} onClose={closeCreateModal} onCreate={addProject} />
